...
* Be diligent in your scheduling. Signing on to a post in ministry means you give up the right to thoughtless time
* Assign the most important things the best time.
* Know the difference between urgent and important

### Minimize distractions and temptations
* Steward your mobile life
* Scheduling hacks
* Deep Work Ideas
* Communicating expectations - You have to teach the congregation where these expectations live.
    * When you can and can't be reached, and 
    * how you can be reached, and 
    * why you can be reached
    * Don't become a slave to voicemails, phone calls, and text messages.

### Be all in on what you're doing at the moment
* This is about inegrity to yourself and others
* Once time is carved out, use that time for it's intended purpose (or people)
